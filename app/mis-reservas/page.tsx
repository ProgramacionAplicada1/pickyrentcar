...
import { Calendar01Icon, Car01Icon, CheckmarkBadge01Icon, Time01Icon } from "@hugeicons/core-free-icons"
              ...
              <div key={reserva.id} className="group flex flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition-all hover:shadow-md hover:border-slate-300">
                ...
                <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50/50 px-6 py-4">
                  <div className="flex items-center gap-2 text-sm font-semibold text-slate-900">
                    ...
                    <span className="truncate max-w-[150px]">{reserva.vehiculo}</span>
                  </div>
                  <span
                ...
                <div className="flex flex-1 flex-col justify-between p-6">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="mt-1 font-medium text-slate-900">{reserva.numero_reserva}</p>
                    </div>
                    <div>
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-100">
                    <Link 
                      href={`/mis-reservas/${reserva.numero_reserva}`}
